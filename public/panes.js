...
// ui-type-v1 row 6: a 200px plot (P16 had 112). 900 - 222 chrome - 17 rows x 28 leaves 206px, so
// P20's 17-row window still fits at 1440x900.
const CHART = { def: 200, min: 70, key: 'pane:chart', legacy: 'chartH' };
